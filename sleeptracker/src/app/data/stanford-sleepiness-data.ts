...
export class StanfordSleepinessData extends SleepData {
	...
	public loggedAt;
	public initDate;
	constructor(loggedValue:number, initDate:Date = new Date()) {
		super();
	...
	dateString():string {
		return "" + this.initDate.toLocaleString('en-US', { weekday: 'long', month: 'long', day: 'numeric' })
		+" at "+ this.initDate.toLocaleTimeString();  
	}
}
